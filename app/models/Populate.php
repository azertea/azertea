...
class Populate {
	...
	*/
	public static function go(){
		...
		//entreprises
		DB::table('entreprise')->insert(array(	'n_Siret' => 4048332,
												'nom' => 'Amazon',
												'aprouve' => true
											));
		DB::table('entreprise')->insert(array(	'n_Siret' => 4986722,
												'nom' => 'CDiscount',
												'aprouve' => true
											));
		DB::table('entreprise')->insert(array(	'n_Siret' => 4757822,
												'nom' => 'Fnac',
												'aprouve' => false
											));
		...
		DB::table('utilisateur')->insert(array('pseudo' => 'AzerTea',
												'email' => 'azer@tea.com',
		...
		DB::table('utilisateur')->insert(array('pseudo' => 'speudonime',
												'email' => 'azer@tea.com',
												'mdp' => 'df6b9fb15cfdbb7527be5a8a6e39f39e572c8ddb943fbc79a943438e9d3d85ebfc2ccf9e0eccd9346026c0b6876e0e01556fe56f135582c05fbdbb505d46755a',
												 'est_valide' => true,
												 'id_particulier' => 2
												 ));
		DB::table('utilisateur')->insert(array('pseudo' => 'abcdef',
												'email' => 'azer@tea.com',
												'mdp' => 'df6b9fb15cfdbb7527be5a8a6e39f39e572c8ddb943fbc79a943438e9d3d85ebfc2ccf9e0eccd9346026c0b6876e0e01556fe56f135582c05fbdbb505d46755a',
												 'est_valide' => true,
												 'id_particulier' => 3
												 ));
		DB::table('utilisateur')->insert(array('pseudo' => 'Wlad',
												'email' => 'azer@tea.com',
												'mdp' => 'df6b9fb15cfdbb7527be5a8a6e39f39e572c8ddb943fbc79a943438e9d3d85ebfc2ccf9e0eccd9346026c0b6876e0e01556fe56f135582c05fbdbb505d46755a',
												 'est_valide' => false,
												 'id_particulier' => 4
												 ));
		DB::table('utilisateur')->insert(array('pseudo' => 'Amazon',
												'email' => 'amazon@amazon.com',
												'mdp' => 'df6b9fb15cfdbb7527be5a8a6e39f39e572c8ddb943fbc79a943438e9d3d85ebfc2ccf9e0eccd9346026c0b6876e0e01556fe56f135582c05fbdbb505d46755a',
												 'est_valide' => true,
												 'n_Siret' => 4048332
												 ));
		DB::table('utilisateur')->insert(array('pseudo' => 'CDiscount',
												'email' => 'CDiscount@CDiscount.com',
												'mdp' => 'df6b9fb15cfdbb7527be5a8a6e39f39e572c8ddb943fbc79a943438e9d3d85ebfc2ccf9e0eccd9346026c0b6876e0e01556fe56f135582c05fbdbb505d46755a',
												 'est_valide' => true,
												 'n_Siret' => 4986722
												 ));
		DB::table('utilisateur')->insert(array('pseudo' => 'Fnac',
												'email' => 'Fnac@Fnac.com',
												'mdp' => 'df6b9fb15cfdbb7527be5a8a6e39f39e572c8ddb943fbc79a943438e9d3d85ebfc2ccf9e0eccd9346026c0b6876e0e01556fe56f135582c05fbdbb505d46755a',
												 'est_valide' => true,
												 'n_Siret' => 4757822
