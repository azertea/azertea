...
-->    
       ...
       <div id="panneauLateral">
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <a class="brand" href="#" style="margin-left:5px"><img src="/assets/img/logoufound.png" style="width: 95px;"></a>
                <ul class="nav">
                    <input type="text" id="search_problem_input" class="navbar-search span2" onkeyup="resetColumns(); searchKeywords()">
                </ul>
    ...
    <div id="white_mask_group">
        ...
        <div id="BIIIIIIIGGG_LOOOGGGOOOOO">
        	<img src="assets/img/logoufound.png" style="position:absolute; top:30%; left:0; right:0; margin-left:auto; margin-right:auto; background-color:white; width:350px; z-index:2001; text-align:center;"/>
        </div>
        <div id="searchOverWhiteMask" style="position:absolute; top:50%; left:0; right:0; margin-left:auto; margin-right:auto; background-color:white; width:400px; height:300px; z-index:2001; text-align:center;">
            <form class="">
                <div class="input-append">
                    <input id="mask_search_input" type="text" data-provide="typeahead" placeholder="Un problème ?" onkeypress="hideMaskAndFocus(event)" /> <!-- id="input"-->
